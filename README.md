...
Network Automation is a cross between the discipline of [Network Infrastructure](https://github.com/sindresorhus/awesome#networking) ⭐ 503,974 | 🐛 106 | 📅 2026-09-02 and the discipline of Programming. This list was created to serve as a one-stop shop for information related to Network Automation.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 319,143 | 🐛 19 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 183,451 | 🐛 224 | 🌐 Go | 📅 2026-09-07 - A curated list of awesome Go frameworks, libraries, software and resources.
...
* [Clixon Code](https://github.com/clicon/clixon) ⭐ 256 | 🐛 77 | 🌐 C | 📅 2026-09-07 - Clixon provides an interactive CLI, NETCONF, and RESTCONF configuration interface for a YANG-based device.
...
* [Infrahub GitHub Repo](https://github.com/opsmill/infrahub) ⭐ 513 | 🐛 530 | 🌐 Python | 📅 2026-09-07 - Infrahub - A new approach to Infrastructure Management.
...
* [SuzieQ Repository](https://github.com/netenglabs/suzieq) ⭐ 902 | 🐛 135 | 🌐 Python | 📅 2026-08-29 - Open-source code for the SuzieQ project.
...
* [Nautobot](https://github.com/nautobot/nautobot) ⭐ 1,595 | 🐛 1,013 | 🌐 Python | 📅 2026-09-07 - Nautobot is a Network Source of Truth and Network Automation Platform.
...
* [NAPALM](https://github.com/napalm-automation/napalm) ⭐ 2,501 | 🐛 174 | 🌐 Python | 📅 2026-08-12 - NAPALM (Network Automation and Programmability Abstraction Layer with Multivendor support) is a Python library that implements a set of functions to interact with different router vendor devices using a unified API.
...
* [Template Text Parser](https://github.com/dmulyalin/ttp) ⭐ 391 | 🐛 44 | 🌐 Python | 📅 2026-03-24 - CLI tool and Python module for parsing semi-structured text into structured data. Similar syntax to Jinja templating, but in reverse. TTP Templates [collection](https://github.com/dmulyalin/ttp_templates) ⭐ 71 | 🐛 1 | 🌐 Python | 📅 2026-09-07.
...
* [Hierarchical Configuration](https://github.com/netdevops/hier_config) ⭐ 149 | 🐛 2 | 🌐 Python | 📅 2026-08-27 - Hierarchical Configuration is a Python library that is able to take a running configuration of a network device, compare it to its intended configuration, and build the remediation steps necessary bring a device into spec with its intended configuration.
...
* [pan-os-ansible](https://github.com/PaloAltoNetworks/pan-os-ansible) ⭐ 242 | 🐛 117 | 🌐 Python | 📅 2026-08-31 - Ansible modules for working with Palo Alto Networks PAN-OS.
...
* [pandevice](https://github.com/PaloAltoNetworks/pan-os-python) ⭐ 399 | 🐛 109 | 🌐 Python | 📅 2026-07-22 - Device framework for interacting with Palo Alto Networks devices.
...
* [Topolograph](https://github.com/Vadims06/topolograph) ⭐ 240 | 🐛 9 | 🌐 Smarty | 📅 2026-09-02 - Python-based Web tool for visualisation of OSPF/ISIS topologies and making a prediction of network behaviour in case of network's outage.
...
* [SuzieQ](https://github.com/netenglabs/suzieq) ⭐ 902 | 🐛 135 | 🌐 Python | 📅 2026-08-29 - SuzieQ is a agentless, multi-vendor network observability application.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,552 | 🐛 69 | 🌐 Ruby | 📅 2026-08-31 - Oxidized is a network device configuration backup tool. It's a RANCID replacement!
...
* [NetBox](https://github.com/netbox-community/netbox) ⭐ 21,493 | 🐛 217 | 🌐 Python | 📅 2026-09-07 - NetBox is an IP address management (IPAM) and data center infrastructure management (DCIM) tool.
