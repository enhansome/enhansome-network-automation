...
Network Automation is a cross between the discipline of [Network Infrastructure](https://github.com/sindresorhus/awesome#networking) ⭐ 507,168 | 🐛 106 | 📅 2026-09-02 and the discipline of Programming. This list was created to serve as a one-stop shop for information related to Network Automation.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 321,333 | 🐛 21 | 🌐 Python | 📅 2026-09-15 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 184,532 | 🐛 230 | 🌐 Go | 📅 2026-09-16 - A curated list of awesome Go frameworks, libraries, software and resources.
...
* Getting Started with Batfish
  * [Jupyter Notebook](https://github.com/batfish/pybatfish/tree/master/jupyter_notebooks) ⭐ 243 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-09-17 - Jupyter Notebooks showing how to use Batfish for configuration, ACL, routing, forwarding, etc... analysis.
...
* [Clixon Code](https://github.com/clicon/clixon) ⭐ 256 | 🐛 80 | 🌐 C | 📅 2026-09-17 - Clixon provides an interactive CLI, NETCONF, and RESTCONF configuration interface for a YANG-based device.
* [Clixon Controller Code](https://github.com/clicon/clixon-controller) ⭐ 33 | 🐛 50 | 🌐 Shell | 📅 2026-09-17 - The Clixon controller is an open-source tool for network automation of devices based on NETCONF and YANG.
* [Clixon Home Page](https://clicon.org) - Clixon home page with links to the different projects with code and documentation.

## Infrahub

* [Infrahub GitHub Repo](https://github.com/opsmill/infrahub) ⭐ 519 | 🐛 551 | 🌐 Python | 📅 2026-09-17 - Infrahub - A new approach to Infrastructure Management.
...
* [Nautobot](https://github.com/nautobot/nautobot) ⭐ 1,607 | 🐛 1,022 | 🌐 Python | 📅 2026-09-17 - Nautobot is a Network Source of Truth and Network Automation Platform.
...
* [Nornir](https://github.com/nornir-automation/nornir) ⭐ 1,622 | 🐛 45 | 🌐 Python | 📅 2026-09-06 - Nornir is a pure Python automation framework intended to be used directly from Python.
...
* [Template Text Parser](https://github.com/dmulyalin/ttp) ⭐ 390 | 🐛 44 | 🌐 Python | 📅 2026-03-24 - CLI tool and Python module for parsing semi-structured text into structured data. Similar syntax to Jinja templating, but in reverse. TTP Templates [collection](https://github.com/dmulyalin/ttp_templates) ⭐ 71 | 🐛 1 | 🌐 Python | 📅 2026-09-17.
...
* [FreeZTP](https://github.com/PackeTsar/freeztp) ⭐ 228 | 🐛 11 | 🌐 Python | 📅 2022-11-13 - FreeZTP is an open-source Zero-Touch Provisioning system for Cisco IOS campus switches and routers.
...
* [py-junos-eznc](https://github.com/Juniper/py-junos-eznc) ⭐ 716 | 🐛 54 | 🌐 Python | 📅 2026-09-17 - Python library for Junos automation.
* [pandevice](https://github.com/PaloAltoNetworks/pan-os-python) ⭐ 399 | 🐛 111 | 🌐 Python | 📅 2026-07-22 - Device framework for interacting with Palo Alto Networks devices.
...
* [pyntc](https://github.com/networktocode/pyntc) ⭐ 187 | 🐛 21 | 🌐 Python | 📅 2026-09-17 - Python library focused on tasks related to device level and OS management.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,475 | 🐛 279 | 🌐 Java | 📅 2026-09-17 - Open-source network validation application. Multi-vendor configuration parser with a detailed modeled based simulation to analyze all aspects of network behavior (routing, forwarding, security, etc...).
...
* [Container-Lab](https://github.com/srl-wim/container-lab) ⭐ 2,819 | 🐛 66 | 🌐 Go | 📅 2026-09-16 - Containerlab provides a framework for orchestrating networking labs with containers. It starts the containers, builds a virtual wiring between them to create lab topologies of users choice and manages labs lifecycle.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,475 | 🐛 279 | 🌐 Java | 📅 2026-09-17 - Batfish provides a model-based simulation for multi-vendor networks, that enables routing, forwarding, security, compliance, and what-if scenario analysis of a network (or proposed change to a network).
...
* [NetBox](https://github.com/netbox-community/netbox) ⭐ 21,549 | 🐛 215 | 🌐 Python | 📅 2026-09-17 - NetBox is an IP address management (IPAM) and data center infrastructure management (DCIM) tool.
