...
Network Automation is a cross between the discipline of [Network Infrastructure](https://github.com/sindresorhus/awesome#networking) ⭐ 505,455 | 🐛 106 | 📅 2026-09-02 and the discipline of Programming. This list was created to serve as a one-stop shop for information related to Network Automation.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 320,266 | 🐛 24 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 183,952 | 🐛 231 | 🌐 Go | 📅 2026-09-12 - A curated list of awesome Go frameworks, libraries, software and resources.
...
* [Clixon Code](https://github.com/clicon/clixon) ⭐ 256 | 🐛 77 | 🌐 C | 📅 2026-09-12 - Clixon provides an interactive CLI, NETCONF, and RESTCONF configuration interface for a YANG-based device.
* [Clixon Controller Code](https://github.com/clicon/clixon-controller) ⭐ 32 | 🐛 50 | 🌐 Shell | 📅 2026-09-11 - The Clixon controller is an open-source tool for network automation of devices based on NETCONF and YANG.
* [Clixon Home Page](https://clicon.org) - Clixon home page with links to the different projects with code and documentation.

## Infrahub

* [Infrahub GitHub Repo](https://github.com/opsmill/infrahub) ⭐ 517 | 🐛 534 | 🌐 Python | 📅 2026-09-12 - Infrahub - A new approach to Infrastructure Management.
...
* [SuzieQ Repository](https://github.com/netenglabs/suzieq) ⭐ 904 | 🐛 135 | 🌐 Python | 📅 2026-08-29 - Open-source code for the SuzieQ project.
...
* [Nautobot](https://github.com/nautobot/nautobot) ⭐ 1,599 | 🐛 1,018 | 🌐 Python | 📅 2026-09-12 - Nautobot is a Network Source of Truth and Network Automation Platform.
* [eNMS](https://github.com/afourmy/eNMS) ⭐ 841 | 🐛 29 | 🌐 Python | 📅 2026-05-08 - A vendor-agnostic NMS for carrier-grade network visualization and network automation.
* [netpalm](https://github.com/tbotnz/netpalm) ⭐ 453 | 🐛 19 | 🌐 Python | 📅 2026-03-23 - netpalm is a ReST broker and abstraction layer for NAPALM, Netmiko, NCCLIENT or a Python Script.
...
* [Nornir](https://github.com/nornir-automation/nornir) ⭐ 1,622 | 🐛 44 | 🌐 Python | 📅 2026-09-06 - Nornir is a pure Python automation framework intended to be used directly from Python.
...
* [Capirca](https://github.com/google/capirca) ⭐ 857 | 🐛 54 | 🌐 Python | 📅 2026-09-11 - Multi-platform ACL generation system; can output Juniper/IOS/etc ACLs from the same policy.
...
* [Netutils](https://github.com/networktocode/netutils) ⭐ 255 | 🐛 53 | 🌐 Python | 📅 2026-09-11 - A Python library that is a collection of functions that are used in the common network automation tasks.
...
* [ansible-junos-stdlib](https://github.com/Juniper/ansible-junos-stdlib) ⭐ 338 | 🐛 61 | 🌐 Python | 📅 2026-09-11 - Junos OS modules for Ansible.
...
* [cvprac](https://github.com/aristanetworks/cvprac) ⭐ 51 | 🐛 22 | 🌐 Python | 📅 2026-09-11 - Python library for Arista CVP.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,470 | 🐛 276 | 🌐 Java | 📅 2026-09-12 - Open-source network validation application. Multi-vendor configuration parser with a detailed modeled based simulation to analyze all aspects of network behavior (routing, forwarding, security, etc...).
...
* [Topolograph](https://github.com/Vadims06/topolograph) ⭐ 240 | 🐛 8 | 🌐 Smarty | 📅 2026-09-12 - Python-based Web tool for visualisation of OSPF/ISIS topologies and making a prediction of network behaviour in case of network's outage.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,470 | 🐛 276 | 🌐 Java | 📅 2026-09-12 - Batfish provides a model-based simulation for multi-vendor networks, that enables routing, forwarding, security, compliance, and what-if scenario analysis of a network (or proposed change to a network).
* [SuzieQ](https://github.com/netenglabs/suzieq) ⭐ 904 | 🐛 135 | 🌐 Python | 📅 2026-08-29 - SuzieQ is a agentless, multi-vendor network observability application.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,569 | 🐛 63 | 🌐 Ruby | 📅 2026-09-11 - Oxidized is a network device configuration backup tool. It's a RANCID replacement!
...
* [NetBox](https://github.com/netbox-community/netbox) ⭐ 21,515 | 🐛 217 | 🌐 Python | 📅 2026-09-11 - NetBox is an IP address management (IPAM) and data center infrastructure management (DCIM) tool.
