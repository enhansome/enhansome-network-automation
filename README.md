...
Network Automation is a cross between the discipline of [Network Infrastructure](https://github.com/sindresorhus/awesome#networking) ⭐ 508,246 | 🐛 106 | 📅 2026-09-02 and the discipline of Programming. This list was created to serve as a one-stop shop for information related to Network Automation.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 321,954 | 🐛 19 | 🌐 Python | 📅 2026-09-20 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 184,926 | 🐛 230 | 🌐 Go | 📅 2026-09-20 - A curated list of awesome Go frameworks, libraries, software and resources.
...
* [Clixon Code](https://github.com/clicon/clixon) ⭐ 257 | 🐛 80 | 🌐 C | 📅 2026-09-20 - Clixon provides an interactive CLI, NETCONF, and RESTCONF configuration interface for a YANG-based device.
* [Clixon Controller Code](https://github.com/clicon/clixon-controller) ⭐ 33 | 🐛 50 | 🌐 Shell | 📅 2026-09-20 - The Clixon controller is an open-source tool for network automation of devices based on NETCONF and YANG.
* [Clixon Home Page](https://clicon.org) - Clixon home page with links to the different projects with code and documentation.

## Infrahub

* [Infrahub GitHub Repo](https://github.com/opsmill/infrahub) ⭐ 523 | 🐛 557 | 🌐 Python | 📅 2026-09-20 - Infrahub - A new approach to Infrastructure Management.
...
* [Nautobot](https://github.com/nautobot/nautobot) ⭐ 1,611 | 🐛 1,025 | 🌐 Python | 📅 2026-09-19 - Nautobot is a Network Source of Truth and Network Automation Platform.
...
* [Netmiko](https://github.com/ktbyers/netmiko) ⭐ 4,288 | 🐛 63 | 🌐 Python | 📅 2026-08-18 - Multi-vendor library to simplify Paramiko SSH connections to network devices.
...
* [Hierarchical Configuration](https://github.com/netdevops/hier_config) ⭐ 150 | 🐛 1 | 🌐 Python | 📅 2026-09-20 - Hierarchical Configuration is a Python library that is able to take a running configuration of a network device, compare it to its intended configuration, and build the remediation steps necessary bring a device into spec with its intended configuration.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,478 | 🐛 279 | 🌐 Java | 📅 2026-09-19 - Open-source network validation application. Multi-vendor configuration parser with a detailed modeled based simulation to analyze all aspects of network behavior (routing, forwarding, security, etc...).
...
* [Container-Lab](https://github.com/srl-wim/container-lab) ⭐ 2,825 | 🐛 70 | 🌐 Go | 📅 2026-09-20 - Containerlab provides a framework for orchestrating networking labs with containers. It starts the containers, builds a virtual wiring between them to create lab topologies of users choice and manages labs lifecycle.

* [netlab](https://github.com/ipspace/netlab) ⭐ 740 | 🐛 25 | 🌐 Python | 📅 2026-09-20 - Brings infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository will create configs for VirtualBox/libvirt/containerlab, Ansible inventory, IPv4/v6 addressing, VLANs and VRFs, OSPF, EIGRP, IS-IS, BGP, BFD, MPLS, MPLS/VPN, VXLAN, EVPN and Segment Routing.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,478 | 🐛 279 | 🌐 Java | 📅 2026-09-19 - Batfish provides a model-based simulation for multi-vendor networks, that enables routing, forwarding, security, compliance, and what-if scenario analysis of a network (or proposed change to a network).
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,585 | 🐛 66 | 🌐 Ruby | 📅 2026-09-14 - Oxidized is a network device configuration backup tool. It's a RANCID replacement!
...
* [NetBox](https://github.com/netbox-community/netbox) ⭐ 21,566 | 🐛 220 | 🌐 Python | 📅 2026-09-18 - NetBox is an IP address management (IPAM) and data center infrastructure management (DCIM) tool.
