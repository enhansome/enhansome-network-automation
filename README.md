...
Network Automation is a cross between the discipline of [Network Infrastructure](https://github.com/sindresorhus/awesome#networking) ⭐ 501,740 | 🐛 105 | 📅 2026-08-21 and the discipline of Programming. This list was created to serve as a one-stop shop for information related to Network Automation.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 317,419 | 🐛 19 | 🌐 Python | 📅 2026-08-25 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 182,815 | 🐛 223 | 🌐 Go | 📅 2026-08-31 - A curated list of awesome Go frameworks, libraries, software and resources.
...
* Getting Started with Batfish
  * [Jupyter Notebook](https://github.com/batfish/pybatfish/tree/master/jupyter_notebooks) ⭐ 243 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-08-31 - Jupyter Notebooks showing how to use Batfish for configuration, ACL, routing, forwarding, etc... analysis.
...
* [Clixon Code](https://github.com/clicon/clixon) ⭐ 256 | 🐛 77 | 🌐 C | 📅 2026-08-31 - Clixon provides an interactive CLI, NETCONF, and RESTCONF configuration interface for a YANG-based device.
* [Clixon Controller Code](https://github.com/clicon/clixon-controller) ⭐ 32 | 🐛 51 | 🌐 Shell | 📅 2026-08-28 - The Clixon controller is an open-source tool for network automation of devices based on NETCONF and YANG.
* [Clixon Home Page](https://clicon.org) - Clixon home page with links to the different projects with code and documentation.

## Infrahub

* [Infrahub GitHub Repo](https://github.com/opsmill/infrahub) ⭐ 509 | 🐛 508 | 🌐 Python | 📅 2026-08-31 - Infrahub - A new approach to Infrastructure Management.
...
* [SuzieQ Repository](https://github.com/netenglabs/suzieq) ⭐ 900 | 🐛 133 | 🌐 Python | 📅 2026-08-29 - Open-source code for the SuzieQ project.
...
* [Nautobot](https://github.com/nautobot/nautobot) ⭐ 1,588 | 🐛 1,003 | 🌐 Python | 📅 2026-08-31 - Nautobot is a Network Source of Truth and Network Automation Platform.
...
* [NAPALM](https://github.com/napalm-automation/napalm) ⭐ 2,495 | 🐛 174 | 🌐 Python | 📅 2026-08-12 - NAPALM (Network Automation and Programmability Abstraction Layer with Multivendor support) is a Python library that implements a set of functions to interact with different router vendor devices using a unified API.
* [Nornir](https://github.com/nornir-automation/nornir) ⭐ 1,615 | 🐛 55 | 🌐 Python | 📅 2026-08-28 - Nornir is a pure Python automation framework intended to be used directly from Python.
...
* [Template Text Parser](https://github.com/dmulyalin/ttp) ⭐ 391 | 🐛 44 | 🌐 Python | 📅 2026-03-24 - CLI tool and Python module for parsing semi-structured text into structured data. Similar syntax to Jinja templating, but in reverse. TTP Templates [collection](https://github.com/dmulyalin/ttp_templates) ⭐ 71 | 🐛 1 | 🌐 Python | 📅 2026-08-31.
...
* [Aerleon](https://github.com/aerleon/aerleon) ⭐ 262 | 🐛 85 | 🌐 Python | 📅 2026-08-26 - Multi-platform ACL generation system with plugin support, YAML-based config, and a Python API. Fork of Capirca.
* [Netutils](https://github.com/networktocode/netutils) ⭐ 255 | 🐛 39 | 🌐 Python | 📅 2026-08-26 - A Python library that is a collection of functions that are used in the common network automation tasks.
...
* [Need To Graph](https://github.com/dmulyalin/N2G) ⭐ 177 | 🐛 9 | 🌐 Python | 📅 2025-04-28 - A library to generate diagrams in yWorks GraphML, diagrams.net/draw\.io or JSON formats using structured data or show commands output.
...
* [Hierarchical Configuration](https://github.com/netdevops/hier_config) ⭐ 150 | 🐛 0 | 🌐 Python | 📅 2026-08-27 - Hierarchical Configuration is a Python library that is able to take a running configuration of a network device, compare it to its intended configuration, and build the remediation steps necessary bring a device into spec with its intended configuration.
...
* [ara](https://github.com/openstack/ara) ⭐ 2,020 | 🐛 133 | 🌐 Python | 📅 2026-07-13 - Ansible Runtime Analysis.
* [ansible-junos-stdlib](https://github.com/Juniper/ansible-junos-stdlib) ⭐ 338 | 🐛 58 | 🌐 Python | 📅 2026-08-24 - Junos OS modules for Ansible.
...
* [pan-os-ansible](https://github.com/PaloAltoNetworks/pan-os-ansible) ⭐ 240 | 🐛 117 | 🌐 Python | 📅 2026-08-31 - Ansible modules for working with Palo Alto Networks PAN-OS.
...
* [py-junos-eznc](https://github.com/Juniper/py-junos-eznc) ⭐ 716 | 🐛 53 | 🌐 Python | 📅 2026-06-22 - Python library for Junos automation.
...
* [dnacentersdk](https://github.com/cisco-en-programmability/dnacentersdk) ⭐ 83 | 🐛 13 | 🌐 Python | 📅 2026-05-08 - Python library for Cisco DNA Center Platform API.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,461 | 🐛 277 | 🌐 Java | 📅 2026-09-01 - Open-source network validation application. Multi-vendor configuration parser with a detailed modeled based simulation to analyze all aspects of network behavior (routing, forwarding, security, etc...).
...
* [Topolograph](https://github.com/Vadims06/topolograph) ⭐ 237 | 🐛 9 | 🌐 Smarty | 📅 2026-08-31 - Python-based Web tool for visualisation of OSPF/ISIS topologies and making a prediction of network behaviour in case of network's outage.
...
* [Container-Lab](https://github.com/srl-wim/container-lab) ⭐ 2,784 | 🐛 49 | 🌐 Go | 📅 2026-08-31 - Containerlab provides a framework for orchestrating networking labs with containers. It starts the containers, builds a virtual wiring between them to create lab topologies of users choice and manages labs lifecycle.

* [netlab](https://github.com/ipspace/netlab) ⭐ 735 | 🐛 27 | 🌐 Python | 📅 2026-08-31 - Brings infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository will create configs for VirtualBox/libvirt/containerlab, Ansible inventory, IPv4/v6 addressing, VLANs and VRFs, OSPF, EIGRP, IS-IS, BGP, BFD, MPLS, MPLS/VPN, VXLAN, EVPN and Segment Routing.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,461 | 🐛 277 | 🌐 Java | 📅 2026-09-01 - Batfish provides a model-based simulation for multi-vendor networks, that enables routing, forwarding, security, compliance, and what-if scenario analysis of a network (or proposed change to a network).
* [SuzieQ](https://github.com/netenglabs/suzieq) ⭐ 900 | 🐛 133 | 🌐 Python | 📅 2026-08-29 - SuzieQ is a agentless, multi-vendor network observability application.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,537 | 🐛 66 | 🌐 Ruby | 📅 2026-08-31 - Oxidized is a network device configuration backup tool. It's a RANCID replacement!
...
* [fetchconfig](https://github.com/udhos/fetchconfig) ⭐ 15 | 🐛 2 | 🌐 Perl | 📅 2017-02-01 - fetchconfig is a Perl script for retrieving configuration of multiple devices.
...
* [NetBox](https://github.com/netbox-community/netbox) ⭐ 21,433 | 🐛 196 | 🌐 Python | 📅 2026-08-31 - NetBox is an IP address management (IPAM) and data center infrastructure management (DCIM) tool.
