...
Network Automation is a cross between the discipline of [Network Infrastructure](https://github.com/sindresorhus/awesome#networking) ⭐ 503,667 | 🐛 106 | 📅 2026-09-02 and the discipline of Programming. This list was created to serve as a one-stop shop for information related to Network Automation.
...
* [Awesome Python](https://github.com/vinta/awesome-python) ⭐ 318,862 | 🐛 18 | 🌐 Python | 📅 2026-09-01 - A curated list of awesome Python frameworks, libraries, software and resources.
...
* [Awesome Go](https://github.com/avelino/awesome-go) ⭐ 183,361 | 🐛 224 | 🌐 Go | 📅 2026-09-06 - A curated list of awesome Go frameworks, libraries, software and resources.
...
* [Clixon Code](https://github.com/clicon/clixon) ⭐ 256 | 🐛 77 | 🌐 C | 📅 2026-09-05 - Clixon provides an interactive CLI, NETCONF, and RESTCONF configuration interface for a YANG-based device.
...
* [Infrahub GitHub Repo](https://github.com/opsmill/infrahub) ⭐ 513 | 🐛 527 | 🌐 Python | 📅 2026-09-06 - Infrahub - A new approach to Infrastructure Management.
...
* [salt-sproxy](https://github.com/mirceaulinic/salt-sproxy) ⭐ 120 | 🐛 24 | 🌐 Python | 📅 2024-07-03 - Salt plugin to automate the management and configuration of (network) devices at scale, without running (Proxy) Minions.
...
* [SuzieQ Repository](https://github.com/netenglabs/suzieq) ⭐ 902 | 🐛 133 | 🌐 Python | 📅 2026-08-29 - Open-source code for the SuzieQ project.
...
* [Nautobot](https://github.com/nautobot/nautobot) ⭐ 1,595 | 🐛 1,011 | 🌐 Python | 📅 2026-09-05 - Nautobot is a Network Source of Truth and Network Automation Platform.
* [eNMS](https://github.com/afourmy/eNMS) ⭐ 840 | 🐛 29 | 🌐 Python | 📅 2026-05-08 - A vendor-agnostic NMS for carrier-grade network visualization and network automation.
...
* [Netmiko](https://github.com/ktbyers/netmiko) ⭐ 4,272 | 🐛 62 | 🌐 Python | 📅 2026-08-18 - Multi-vendor library to simplify Paramiko SSH connections to network devices.
* [NAPALM](https://github.com/napalm-automation/napalm) ⭐ 2,500 | 🐛 174 | 🌐 Python | 📅 2026-08-12 - NAPALM (Network Automation and Programmability Abstraction Layer with Multivendor support) is a Python library that implements a set of functions to interact with different router vendor devices using a unified API.
* [Nornir](https://github.com/nornir-automation/nornir) ⭐ 1,619 | 🐛 44 | 🌐 Python | 📅 2026-09-06 - Nornir is a pure Python automation framework intended to be used directly from Python.
...
* [Template Text Parser](https://github.com/dmulyalin/ttp) ⭐ 391 | 🐛 44 | 🌐 Python | 📅 2026-03-24 - CLI tool and Python module for parsing semi-structured text into structured data. Similar syntax to Jinja templating, but in reverse. TTP Templates [collection](https://github.com/dmulyalin/ttp_templates) ⭐ 71 | 🐛 1 | 🌐 Python | 📅 2026-09-06.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,464 | 🐛 276 | 🌐 Java | 📅 2026-09-06 - Open-source network validation application. Multi-vendor configuration parser with a detailed modeled based simulation to analyze all aspects of network behavior (routing, forwarding, security, etc...).
...
* [Topolograph](https://github.com/Vadims06/topolograph) ⭐ 239 | 🐛 9 | 🌐 Smarty | 📅 2026-09-02 - Python-based Web tool for visualisation of OSPF/ISIS topologies and making a prediction of network behaviour in case of network's outage.
...
* [Container-Lab](https://github.com/srl-wim/container-lab) ⭐ 2,795 | 🐛 65 | 🌐 Go | 📅 2026-09-06 - Containerlab provides a framework for orchestrating networking labs with containers. It starts the containers, builds a virtual wiring between them to create lab topologies of users choice and manages labs lifecycle.

* [netlab](https://github.com/ipspace/netlab) ⭐ 737 | 🐛 25 | 🌐 Python | 📅 2026-09-05 - Brings infrastructure-as-code concepts to networking labs. You'll describe your high-level network topology and routing design in a YAML file, and the tools in this repository will create configs for VirtualBox/libvirt/containerlab, Ansible inventory, IPv4/v6 addressing, VLANs and VRFs, OSPF, EIGRP, IS-IS, BGP, BFD, MPLS, MPLS/VPN, VXLAN, EVPN and Segment Routing.
...
* [Batfish](https://github.com/batfish/batfish) ⭐ 1,464 | 🐛 276 | 🌐 Java | 📅 2026-09-06 - Batfish provides a model-based simulation for multi-vendor networks, that enables routing, forwarding, security, compliance, and what-if scenario analysis of a network (or proposed change to a network).
* [SuzieQ](https://github.com/netenglabs/suzieq) ⭐ 902 | 🐛 133 | 🌐 Python | 📅 2026-08-29 - SuzieQ is a agentless, multi-vendor network observability application.
...
* [Oxidized](https://github.com/ytti/oxidized) ⭐ 3,547 | 🐛 68 | 🌐 Ruby | 📅 2026-08-31 - Oxidized is a network device configuration backup tool. It's a RANCID replacement!
...
* [NetBox](https://github.com/netbox-community/netbox) ⭐ 21,486 | 🐛 214 | 🌐 Python | 📅 2026-09-06 - NetBox is an IP address management (IPAM) and data center infrastructure management (DCIM) tool.
